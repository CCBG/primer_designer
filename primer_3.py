# Nicholas Gleadall - 20th August 2015
# Script for the generation of textfiles for primer3

# ----------------------------------
# Functions
# ----------------------------------

def make_input_file(seq_id, seq):
...
='''
    ...
    with open( seq_id + ".prime3", 'w+') as outfile:

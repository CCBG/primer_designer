...
primer_design.analysis.pick_best_primers( primer_data, '9', 129455552, 129455552)
products = primer_design.analysis.digital_PCR( primer_data )
(fwd_primer, rev_primer, size) = primer_design.analysis.best_product( products )

print "{} {} {}".format(fwd_primer, rev_primer, size)
